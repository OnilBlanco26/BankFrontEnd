      ...
      {modalIsOpen ? (
        ...
        >
          ...
          >
            ...
            <input
              className="w-[45%] bg-gradient-to-r from-yellow-500/75 to-yellow-100 py-2 rounded-md  shadow-md font-bold text-white hover:bg-none hover:text-white hover:border-2 hover:border-orange hover transition-all duration-300"
              type="submit"
              value="Register"
            />
          </form>
