    ...
    <div className="flex flex-col">
      <div className="flex flex-col border-2 border-orange rounded-md">
        <button
          ...
          onClick={openModal}
        >
          <img className="w-16 sm:w-24" src={transferIcon} alt="Transfer" />
        </button>
        ...
        {modalIsOpen ? (
          <motion.div
            ...
            ref={modalRef}
            className="w-[90%] sm:max-w-[60%] md:max-w-[40%] lg:max-w-[30%] h-[450px] flex flex-col justify-start items-center z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/50  rounded-lg backdrop-blur-md py-14"
          ...
          >
            ...
            >
              <div className="w-[95%] sm:w-[80%] flex flex-col items-center justify-between">
                <input
                  className="bg-transparent border-4 border-double border-orange rounded-md p-2 w-full placeholder:text-white"
              ...
              <div className="w-[40%] sm:w-[20%] rounded-full flex items-center justify-center font-bold uppercase gap-2 bg-orange shadow-md sm:mt-10 hover:scale-110 transition-all duration-300 active:scale-125">
                <button
