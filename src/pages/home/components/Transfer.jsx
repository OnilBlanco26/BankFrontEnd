...
export const Transfer = () => {
  ...
  return (
    ...
    <div className="flex flex-col border-2 border-orange rounded-md">
      <button className="bg-orange/50 flex justify-center items-center" onClick={openModal}>
        <img className="w-24" src="../../../../public/assets/transferIcon.png" alt="Transfer" />
      </button>
        ...
        >
          ...
          <form className="w-full flex justify-center items-center flex-col gap-4 mt-10" onSubmit={handleSubmit(submit)}>
            <div className="w-[80%] flex items-center justify-between">
              <input className="bg-transparent border-4 border-double border-orange rounded-md p-2 w-1/2 placeholder:text-white" placeholder="Ej: 21902023192023652" type="text" {...register("accountNumber")} />
              <span className="text-white font-bold text-2xl">Cuenta Destinatario</span>
            </div>
            <div className="w-[80%] flex items-center justify-between">
              <input className="bg-transparent border-4 border-double border-orange rounded-md p-2 w-1/2 placeholder:text-white" placeholder="Ej: 500" type="number" {...register("amount")} />
