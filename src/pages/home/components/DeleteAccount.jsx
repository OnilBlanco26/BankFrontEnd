  ...
  return (
    ...
    <div className="flex flex-col border-2 border-red rounded-md">
      ...
      >
        <img
          className="w-24"
          src="../../../../public/assets/deleteIcon.png"
          alt="Transfer"
        />
      </button>
      {modalIsOpen ? (
        ...
        <div className="w-[80%] flex items-center justify-between">
          <input className="bg-transparent border-4 border-double border-red rounded-md p-2 w-1/2 placeholder:text-white" type="text" {...register('accountNumber')} />
          <span className="text-white text-center font-bold text-2xl">Confirmar Cuenta</span>
        </div>
        <div className="w-[80%] flex items-center justify-between">
          <input className="bg-transparent border-4 border-double border-red rounded-md p-2 w-1/2 placeholder:text-white" type="number" {...register('password')}/>
          <span className="text-white font-bold text-2xl">Confirmar Password</span>
        </div>
